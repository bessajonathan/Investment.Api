    ...
    public partial class createtable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserActives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserActives_Actives_ActiveId",
                        column: x => x.ActiveId,
                        principalTable: "Actives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserActives_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActives_ActiveId",
                table: "UserActives",
                column: "ActiveId");

            migrationBuilder.CreateIndex(
                name: "IX_UserActives_UserId",
                table: "UserActives",
                column: "UserId");
